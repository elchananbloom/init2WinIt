...
function BankLoansPerQuarter() {
    const url = "http://localhost:8080/api/statistics/bank/loans";
    ...
    return (<>
        <BarChart
            height={300}
            series={[
                { data: uData, label: 'Total Amount Loaned', id: 'uvId' },
            ]}
            xAxis={[{ data: xLabels }]}
            yAxis={[{ width: 50 }]}
        />
...
export default BankLoansPerQuarter;